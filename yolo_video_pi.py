...
east_decorator = 'C:/Users/kate1/capstone/keras-yolo3/frozen_east_text_detection.pb' #경로
...
#BikesHelmets27.png   nohelmet.PNG
img = Image.open(os.path.join('C:/Users/kate1/capstone/BikesHelmets27.png')) #경로
img_copy = img.copy()
